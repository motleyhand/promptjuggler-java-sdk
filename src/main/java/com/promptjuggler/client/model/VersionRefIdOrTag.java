...
@JsonDeserialize(using = VersionRefIdOrTag.VersionRefIdOrTagDeserializer.class)
@JsonSerialize(using = VersionRefIdOrTag.VersionRefIdOrTagSerializer.class)
public class VersionRefIdOrTag extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(VersionRefIdOrTag.class.getName());

    public static class VersionRefIdOrTagSerializer extends StdSerializer<VersionRefIdOrTag> {
        public VersionRefIdOrTagSerializer(Class<VersionRefIdOrTag> t) {
            super(t);
        }

        public VersionRefIdOrTagSerializer() {
            this(null);
        }

        @Override
        public void serialize(VersionRefIdOrTag value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class VersionRefIdOrTagDeserializer extends StdDeserializer<VersionRefIdOrTag> {
        public VersionRefIdOrTagDeserializer() {
            this(VersionRefIdOrTag.class);
        }

        public VersionRefIdOrTagDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public VersionRefIdOrTag deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                VersionRefIdOrTag ret = new VersionRefIdOrTag();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for VersionRefIdOrTag: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public VersionRefIdOrTag getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "VersionRefIdOrTag cannot be null");
        }
    }
    ...
    public VersionRefIdOrTag() {
        super("oneOf", Boolean.FALSE);
    }

    public VersionRefIdOrTag(Integer o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public VersionRefIdOrTag(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(VersionRefIdOrTag.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return VersionRefIdOrTag.schemas;
    }
